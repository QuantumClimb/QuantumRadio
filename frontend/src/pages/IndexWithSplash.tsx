...
const IndexWithSplash = () => {
  ...
  // Load data immediately when component mounts (even during splash)
  useEffect(() => {
    loadData();
  }, []);
        ...
        <div className="flex-1 py-8 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <header className="text-center mb-8 mobile-header">
              ...
              {/* Stats Bar - Updated with real-time data */}
              {stats && (
...
export default IndexWithSplash; 